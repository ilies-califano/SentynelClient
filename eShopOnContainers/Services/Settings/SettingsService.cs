...
namespace SentynelAndroidClient.Services.Settings;
...
public class SettingsService : ISettingsService
{
    ...
    private readonly string UrlGatewayShoppingDefault = GlobalSetting.Instance.BaseSentynelApiEndpoint;
    #endregion
    ...
    public string GatewayShoppingEndpointBase
    {
        ...
        set
        {
            ...
            GlobalSetting.Instance.BaseSentynelApiEndpoint = value;
        }
    }
