...
public class SettingsViewModel : ViewModelBase
{
    ...
    public static string TitleUseAzureServices => "Use Microservices/Containers from SentynelAndroidClient";
    ...
    {
        GlobalSetting.Instance.BaseSentynelApiEndpoint = _settingsService.GatewayShoppingEndpointBase = _gatewayShoppingEndpoint;
    }
